...
Interactive posts allow you to build apps like [live scoreboards](./showcase/apps.mdx#live-scores), [polls](./showcase/playgrounds.mdx), or [community games](./community_games.md) on Reddit. This guide will help you understand how to build them effectively.
...
You can find some webview example games [here](./webviews.md#basic-example)
